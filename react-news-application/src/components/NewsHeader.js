...
import classes from "./NewsHeader.css";
      ...
      <Navbar color="dark" dark expand="md">
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="ml-auto" navbar>
              ...
              <Form inline>
                <FormGroup row className="mb-2 mr-2  mb-sm-0">
                  ...
                  <Col lg={2} className="p-0">
                    <Button onClick={searchHandler} outline type="button">
                      Search
                    </Button>
                  </Col>
                </FormGroup>
            ...
            <NavItem>
              <NavLink
                onClick={props.topHeadLineHandler}
                className={classes["navlink-1"]}
              >
                Top-Headlines
              </NavLink>
            </NavItem>
